                ...
                <tr>
                  <td style="background-color:#a89060; border-radius:8px;">
                    <a href="${process.env.FRONTEND_URL || 'http://localhost:3000'}/login"
                       style="display:inline-block; padding:14px 32px; font-size:15px; color:#ffffff; text-decoration:none; font-family: Arial, sans-serif; letter-spacing:0.5px; font-weight:bold;">
                      Ir a NovaLibros →
                    </a>
                  </td>
                </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="33%" style="text-align:center; padding: 0 8px;">
                    ...
                    <p style="margin:0; font-size:13px; color:#777; font-family:Arial,sans-serif; line-height:1.5;">Miles de<br/>títulos</p>
                  </td>
                  <td width="33%" style="text-align:center; padding: 0 8px;">
                    <p style="font-size:24px; margin:0 0 8px 0;">🛒</p>
                    <p style="margin:0; font-size:13px; color:#777; font-family:Arial,sans-serif; line-height:1.5;">Compra<br/>fácil</p>
                  </td>
                  <td width="33%" style="text-align:center; padding: 0 8px;">
                    <p style="font-size:24px; margin:0 0 8px 0;">⭐</p>
                    <p style="margin:0; font-size:13px; color:#777; font-family:Arial,sans-serif; line-height:1.5;">Reseñas y<br/>comunidad</p>
                  </td>
                </tr>
              </table>
            </td>
